...
public class TestMigrator {
	...
	public void migrate(PotentialRFC pRFC) throws Exception {
...
//			// 测试文件不是增加，且新旧不一致
//			if (!testFile.getOldPath().contains("/dev/null")) {
//				if (!testFile.getOldPath().equals(testFile.getNewPath())) {
//					System.out.println("不是新增加，且新旧测试文件路径被不一致");
//					return false;
//				}
//			}
